...
export const projects = [
  {
    title: "AI Chat Bot",
    description: "Developed a AI-Powered full-stack web application with user authentication, real-time database, and cloud storage using Firebase.Integrated Google Gemini API to enable intelligent AI-powered features and responses within the app",
    image: "/Ai chat bot.png",
    imageAiHint: "AI robot",
    link: "https://juabhi-ai.vercel.app/",
  ...
  },
  {
    ...
    description: "Created a realistic 3D perfume bottle model in Blender, focusing on shape, texture, and lighting to achieve a professional product design look.This project demonstrates skills in 3D modeling, rendering, and attention to detail for product visualization.",
    image: "/perfume.jpg",
    imageAiHint: "Blender 3D",
    link: "https://drive.google.com/drive/folders/19cfNWSt4TLwfO1D_v0B5nHDPUUu0av2g",
    tags: ["Blender 3D"],
  },
  {
    title: "Portfolio",
...
export const skills: Skill[] = [
  ...
  { name: "React / Next.js", icon: Code, description: "Modern framework for creating fast, server-rendered React applications." },
